...
const ProductAddPage = () => {
  ...
  return (
   ...
   <Nax/>
    <div className="font-sans bg-white text-black min-h-screen px-4 py-10 md:px-20 md:py-16">
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className="w-full md:w-1/2 space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            />
            <button className="bg-[#f26322] text-white font-semibold px-6 py-2 uppercase tracking-wider">
              Add to Basket
            </button>
          </div>
          ...
          <p className="text-base">
            Exclusively designed print by <a href="#" className="underline">Stanley Chow</a>,
            featuring a quote from a letter of advice written by Ernest Hemingway to
            F. Scott Fitzgerald:
          </p>
