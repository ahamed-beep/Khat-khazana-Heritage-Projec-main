...
const EXCHANGE_RATE = 277; // 1 USD ≈ 277 PKR
...
const Productviewpage = () => {
  ...
  const basePricePKR = 11800;

  const formattedPrice =
    currency === "PKR"
      ? `Rs.${basePricePKR.toLocaleString()}`
      : `$${(basePricePKR / EXCHANGE_RATE).toFixed(2)}`;
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-10">
        ...
        <div className="w-full md:w-1/2 space-y-6">
          ...
          <p className="text-base">
            ...
            , featuring a quote from a letter of advice written by Ernest
          ...
          <p className="text-sm text-gray-700 mt-6">
            Limited edition of 500, each hand-numbered and signed by Stanley
            Chow. <br />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-20 pt-10 border-t text-sm text-gray-800">
        ...
        <div>
          <h3 className="font-bold mb-2">
            Sign up for spam-free emails about our new books
          </h3>
          <div className="flex border border-gray-300 rounded overflow-hidden max-w-md">
            ...
            />
            <button className="bg-[#f26322] text-white px-4 py-2 font-semibold">
              SUBSCRIBE
            </button>
          </div>
        </div>
